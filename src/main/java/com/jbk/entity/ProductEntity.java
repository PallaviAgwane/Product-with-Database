...
public class ProductEntity {
	...
	public ProductEntity(Long productId, String productName, SupplierEntity supplierEntity,
			CategoryEntity categoryEntity, Integer productQty, Double productPrice) {
		super();
